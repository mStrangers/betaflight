...
// PG_GPS_CONFIG
    ...
    { "vol_lim_max_altitude",       VAR_UINT16 | MASTER_VALUE, .config.minmax = { 5, 500 }, PG_VOLUME_LIMITATION, offsetof(volLimitationConfig_t, maxAltitude) },
    ...
    { "vol_lim_max_dist",           VAR_UINT16 | MASTER_VALUE, .config.minmax = { 20, 5000 }, PG_VOLUME_LIMITATION, offsetof(volLimitationConfig_t, maxDistance) },
