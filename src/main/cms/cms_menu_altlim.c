...
{
    { "-- ALT LIMIT --",  OME_Label, NULL, NULL, 0 },
    { "CUTOFF",    OME_UINT16,NULL, &(OSD_UINT16_t){ &cmsx_alt_cutoff_lim, 0, 1000, 1 }, 0 },
    { "BUFFER",    OME_UINT16,NULL, &(OSD_UINT16_t){ &cmsx_alt_buffer_lim, 0, 1000, 1 }, 0 },
